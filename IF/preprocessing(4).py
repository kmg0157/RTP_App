...
# 파일 경로 설정
directory_path = r'C:\Users\NetDB\Desktop\RTP2\IF'
data_directory_path = r'C:\Users\NetDB\Desktop\RTP2\IF\output_folder'
...
# 최종 데이터프레임 CSV로 저장
output_file_path = os.path.join(directory_path, 'preprocessing.csv')
